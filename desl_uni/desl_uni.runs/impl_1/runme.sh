...
HD_PWD='C:/Users/Alunos/Documents/desl_uni/desl_uni.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Desl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Desl.tcl -notrace
